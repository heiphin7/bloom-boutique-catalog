    ...
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader className="flex flex-row items-center justify-between">
          ...
          >
            {order.status === "paid" ? (
              <><BadgeCheck className="w-3 h-3 mr-1" /> Оплачен</>
            ) : (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
          ...
          <Card>
            <CardContent className="pt-6">
              <h3 className="font-medium text-lg mb-3">Информация о покупателе</h3>
          ...
          <Card>
            <CardContent className="pt-6">
              <h3 className="font-medium text-lg mb-3">Информация о заказе</h3>
              <div className="space-y-3">
                <div className="flex items-start gap-2">
        ...
        <Card className="mt-6">
          <CardContent className="pt-6">
            <h3 className="font-medium text-lg mb-3">Адрес доставки</h3>
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p>{address.country}</p>
                <p className="text-sm text-gray-500 mt-1">Адрес доставки</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="mt-6">
          <CardContent className="pt-6">
            <h3 className="font-medium text-lg mb-3">Товары в заказе</h3>
                ...
                <div key={`${order.id}-${product.id}`} className="flex items-center gap-4 pb-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center text-sm text-gray-500">
                      ...
                      <span>{formatKztPrice(product.price)} за шт.</span>
                    </div>
                  </div>
